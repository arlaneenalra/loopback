 ...
 * @param realmDelimiter The realm delimiter, if not set, no realm is needed
 * @returns {Object} The normalized credential object
 */
User.normalizeCredentials = function(credentials, realmDelimiter) {
  var query = {};
...
User.login = function(credentials, include, fn) {
  ...
  var query = self.normalizeCredentials(credentials, realmDelimiter);

  if(realmDelimiter && !query.realm) {
